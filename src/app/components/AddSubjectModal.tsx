...
function CreateSubjectForm({findOrCreateSubject, setModalOpen}: CreateSubjectFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    const res = await findOrCreateSubject({
      title,
      description,
...
function CreateSubjectPanel({findOrCreateSubject, setModalOpen}: CreateSubjectFormProps) {
  return  <DialogPanel
              transition
            ...
            >
              ...
              <CreateSubjectForm findOrCreateSubject={findOrCreateSubject} setModalOpen={setModalOpen}/>
            </DialogPanel>
}
...
export default function AddSubjectModal({findOrCreateSubject}: AddSubjectModalProps) {
  const [modalOpen, setModalOpen] = useState(false);
  const panel = <CreateSubjectPanel findOrCreateSubject={findOrCreateSubject} setModalOpen={setModalOpen}/>
  return (
    <>
